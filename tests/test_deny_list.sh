...
t "deny secrets.py"                   "SKIP"   "$(classify secrets.py)"
t "deny nested secrets.py"            "SKIP"   "$(classify app/secrets.py)"
t "deny credentials.py"               "SKIP"   "$(classify credentials.py)"
t "deny nested credentials.py"        "SKIP"   "$(classify conf/credentials.py)"
t "deny local_settings.py"            "SKIP"   "$(classify local_settings.py)"
t "deny settings_local.py"            "SKIP"   "$(classify app/settings_local.py)"
t "allow settings.py (reads env, useful)" "ATTACH" "$(classify app/settings.py)"
t "allow secrets_manager.py"          "ATTACH" "$(classify util/secrets_manager.py)"
